...
var Record = {
    ...
    query : function (page) 
    {
		...
		if(Record.op_iotype==1){
			...
			url='/cgi-bin/kf_query_cdh_outcome_list.cgi';
    ...
    init : function () 
    {
        ...
        /* $('income').onclick = function () 
		 ...
		 $('outcome_output').onclick= function(){
				 request.sendQuery.call(this, '/cgi-bin/kf_export_cdh_outcome_list.cgi', [],
	...
	getOutcomeFile_handle : function (xml) {
            ...
            var name = until.getNodeValue("fileload_path", xml); //返回信息
